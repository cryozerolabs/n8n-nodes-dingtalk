...
- 修复：更新待办不再发送接口不支持的详情页地址和优先级字段
- 修复：创建、更新、删除待办及更新执行人状态时，未配置操作人不再发送空的 `operatorId`

感谢 [@songlipeng2003](https://github.com/songlipeng2003) 在 [#40](https://github.com/cryozerolabs/n8n-nodes-dingtalk/pull/40) 中的贡献。
